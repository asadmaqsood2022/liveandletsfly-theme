...
global $bpxl_travelista_options; ?>
	...
	<?php
	// Live and Let's Fly Below Content
	do_action( 'liveandletsfly_below_content' );
	?>
			...
			<?php if (!empty($bpxl_travelista_options['bpxl_footer_logo']['url'])) { ?>
				<div class="logo" class="uppercase">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img width="<?php echo intval( $bpxl_travelista_options['bpxl_footer_logo']['width'] ); ?>" height="<?php echo intval( $bpxl_travelista_options['bpxl_footer_logo']['height'] ); ?>" src="<?php echo esc_url( $bpxl_travelista_options['bpxl_footer_logo']['url'] ); ?>" alt="<?php bloginfo( 'name' ); ?>">
					</a>
				</div>
			<?php } ?>
		</div>
